...
{
    public class GitInitCommand(Project project, IProcessManager processManager, Action<string, string> displayAction) : ICommand
    {
        ...
        public void Execute()
        {
            ...
            StartInfo start = new("git", "init", _project.Folder);
